...
<div class="main-panel">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form action="${pageContext.request.contextPath }/department_add" method="post" class="forms-sample">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding: 0px 15px">
                        <div class="card-body" style="padding-bottom: 0px">
                            <h4 class="card-title">新增一个部门</h4>
                            <div class="form-group row">
                                <label for="depname" class="col-sm-3 col-form-label">部门名</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="depname"
                                           placeholder="部门名" name="depname">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form action="${pageContext.request.contextPath }/department_update" method="post" class="forms-sample">
                <div class="modal-content">
                    <div class="modal-header" style="padding-bottom: 0px">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form action="${pageContext.request.contextPath }/department_delete" method="post" class="forms-sample">
                <div class="modal-content">
                    <div class="modal-header" style="padding-bottom: 0px">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
...
<script>
    ...
    function toupdate(id) {
        $.getJSON("${pageContext.request.contextPath }/department_toupdate", {"id": id}, function (data) {
            $("#updateModal #id").val(id);
            $("#updateModal #depname").val(data.depname);
