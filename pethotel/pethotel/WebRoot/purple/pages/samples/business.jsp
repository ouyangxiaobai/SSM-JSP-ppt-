...
<div class="main-panel">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form action="${pageContext.request.contextPath }/business/add" method="post" class="forms-sample">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding: 0px 15px">
                        <div class="card-body" style="padding-bottom: 0px">
                            ...
                            <div class="form-group row">
                                <label for="bphoto" class="col-sm-3 col-form-label">图片</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="bphoto"
                                           placeholder="图片" name="bphoto">
                                </div>
                            </div>
                    ...
                    <div class="modal-body" style="padding: 0px 15px">
                        <div class="card-body" style="padding-bottom: 0px">
                            ...
                            <div class="form-group row">
                                <label for="bphoto" class="col-sm-3 col-form-label">图片</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="bphoto"  name="bphoto" >
                                </div>
                            </div>
...
<script>
    ...
    function toupdate(id) {
        $.getJSON("${pageContext.request.contextPath }/business/toupdate", {"id": id}, function (data) {
