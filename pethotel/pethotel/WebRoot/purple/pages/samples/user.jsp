                    ...
                    <div class="modal-body" style="padding: 0px 15px">
                        <div class="card-body" style="padding-bottom: 0px">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" class="form-control" id="uaddress" placeholder="地址" name="uaddress" rows="4">
                                    </textarea>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <form action="${pageContext.request.contextPath }/user/update" method="post" class="forms-sample">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding: 0px 15px">
                        <div class="card-body" style="padding-bottom: 0px">
                            <h4 class="card-title">修改用户资料</h4>
                            <input type="hidden" class="form-control" name="id" id="id" placeholder="这里是id"
                                   style="width: 100px">
                            <input type="hidden" class="form-control" name="weizhi" id="weizhi" value="houtai"
                                   placeholder="位置" style="width: 100px">
                            <div class="form-group row">
                                <label for="username" class="col-sm-3 col-form-label">用户名</label>
                                <div class="col-sm-9">
        ...
        <div class="modal-dialog" role="document">
            <form action="${pageContext.request.contextPath }/user/delete" method="post" class="forms-sample">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding: 0px 15px">
                        确定删除该用户？
                        <input type="text" class="form-control " name="weizhi" id="weizhi" value="houtai"
                               placeholder="位置" style="width: 100px">
                        <input type="text" class="form-control" name="id" id="id" value="这里是id" style="width: 100px">
                    </div>
                    <div class="modal-footer" style="padding-top: 0px">
                        <button type="button" class="btn btn-light" data-dismiss="modal">取消</button>
