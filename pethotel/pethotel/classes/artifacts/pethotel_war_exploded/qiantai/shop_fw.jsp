                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">宠舍服务</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="shop-sidebar-area">
                        ...
                        <div class="shop-widget catagory mb-50">
                            <h4 class="widget-title">宠舍服务</h4>
                            <div class="widget-desc">
                                <!-- Single Checkbox -->
                                    <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                                        <span class="text-muted">宠物洗护</span>
                                    </div>
                                    <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                                        <span class="text-muted">宠物美容</span>
                                    </div>
                                    <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                                        <span class="text-muted">宠物护理</span>
                                    </div>
                                    <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                                        <span class="text-muted">宠物摄影</span>
                                    </div>
                            </div>
                        </div>
                    </div>
