                            ...
                            <div class="form-group row hidde">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="btype"
                                           value="服务类" name="btype">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="btroom" class="col-sm-3 col-form-label">类别</label>
                                <div class="col-sm-9">
        ...
        <div class="modal-dialog" role="document">
            <form action="${pageContext.request.contextPath }/business/update" method="post" class="forms-sample">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding: 0px 15px">
                        <div class="card-body" style="padding-bottom: 0px">
                            <h4 class="card-title">修改服务资料</h4>
                            <input type="hidden" class="form-control" name="id" id="id" value="这里是id"
                                   style="width: 100px">
                            <input type="hidden" class="form-control" name="btype" id="btype" value="服务类"
                                   style="width: 100px">

                            <div class="form-group row">
                                <label for="btroom" class="col-sm-3 col-form-label">类型</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="btroom"  name="btroom" >
                                </div>
                            </div>
